            ...
            var Dt = function() {
                function t(e) {
                    ...
                    this.insertParagraph = this.wrapCommand((function() {
                        ...
                        n.isLimited(i()(t).text().length) || (n.getLastRange().insertNode(t), n.setLastRange(yt.createFromNodeAfter(t).select()))
                ...
                return e = t, (n = [{
                    ...
                    key: "setLastRange",
                    value: function(t) {
                        t ? this.lastRange = t : (this.lastRange = yt.create(this.editable), 0 === i()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = yt.createFromBodyElement(this.editable)))
                    }
                }, {
                    key: "getLastRange",
                    value: function() {
                    ...
                    value: function(t, e) {
                        ...
                        return (n = t, i.a.Deferred((function(t) {
                            ...
                            o.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", Math.min(o.$editable.width(), t.width()))), t.show(), o.getLastRange().insertNode(t[0]), o.setLastRange(yt.createFromNodeAfter(t[0]).select()), o.afterCommand()
                        })).fail((function(t) {
                    ...
                    value: function() {
                        var t = this.getLastRange();
                        return t.isOnAnchor() && (t = yt.createFromNode(ft.ancestor(t.sc, ft.isAnchor))), t.toString()
                    }
                }, {
                    key: "onFormatBlock",
                    value: function(t, e) {
                    ...
                    value: function(t, e) {
                        ...
                        if ("" !== n) {
                            ...
                            if (this.$editor.find(".note-status-output").html(""), i()(o).css(t, e), n.isCollapsed()) {
                                var r = x.head(o);
                                r && !ft.nodeLength(r) && (r.innerHTML = ft.ZERO_WIDTH_NBSP_CHAR, yt.createFromNodeAfter(r.firstChild).select(), this.setLastRange(), this.$editable.data("bogus", r))
                            }
                        } else {
                            var a = i.a.now();
                ...
                return e = t, (n = [{
                    ...
                    value: function(t) {
                        ...
                        if (n && 11 === n[1].length) {
                            ...
                            e = i()("<iframe>").attr("frameborder", 0).attr("src", "https://www.youtube.com/embed/" + m + (v > 0 ? "?start=" + v : "")).attr("width", "95%").attr("height", "360")
                        } else if (o && o[0].length) e = i()("<iframe>").attr("frameborder", 0).attr("src", "https://instagram.com/p/" + o[1] + "/embed/").attr("width", "95%").attr("height", "710").attr("scrolling", "no").attr("allowtransparency", "true");
                        ...
                        else if (a && a[3].length) e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("src", "https://player.vimeo.com/video/" + a[3]).attr("width", "95%").attr("height", "360");
                        else if (s && s[2].length) e = i()("<iframe>").attr("frameborder", 0).attr("src", "https://www.dailymotion.com/embed/video/" + s[2]).attr("width", "95%").attr("height", "360");
                        else if (l && l[1].length) e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "498").attr("width", "95%").attr("src", "https://player.youku.com/embed/" + l[1]);
                        else if (c && c[1].length || u && u[2].length) {
                            var w = c && c[1].length ? c[1] : u[2];
                            e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "310").attr("width", "95%").attr("src", "https://v.qq.com/iframe/player.html?vid=" + w + "&amp;auto=0")
            ...
            var s = function() {
                function t(e, n) {
                    if (function(t, e) {
                            ...
                            trigger: "hover focus",
                            placement: "bottom"
                        }, n), this.$tooltip = i()(['<div class="note-tooltip">', '<div class="note-tooltip-arrow"/>', '<div class="note-tooltip-content"/>', "</div>"].join("")), "manual" !== this.options.trigger) {
